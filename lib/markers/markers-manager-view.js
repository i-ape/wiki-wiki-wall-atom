    ...
    return (
      <div className="wiki-wiki-wall-markers-manager-view">
        ...
        <button
          ...
          onClick={() => this.marker_manager.removeMarker()}
        >
        ...
        <button
          className="btn"
          disabled={marker_count == 0}
          onClick={() => this.marker_manager.clearAllMarkers()}
        >
          Clear All Markers
        </button>
        ...
        <button
          className="btn"
          onClick={() => this.svgs_manager.closeAllSVGs()}
        >
          Close All SVGs
        </button>
        <button
          className="btn"
          onClick={() => this.svgs_manager.generateSVGs()}
        >
          Generate SVGs
        </button>
        <span>
